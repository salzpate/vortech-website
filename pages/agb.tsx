      ...
      <PageSection headline="Allgemeine Geschäftsbedingungen für den Kauf und die Lieferung neuwertiger Waren durch die Verkäuferfirma" id="agb">
        <div className="pb-8 page-section">
          ...
          <p className="my-4">
            ...
            er nach dem Ablauf dieser Frist die Erfüllung des Vertrages durch den Käufer ablehne. Nach erfolglosem Ablauf der Nachfrist ist der Verkäufer berechtigt, durch schriftliche Erklärung vom Kaufvertrag zurückzutreten oder
          ...
          <p className="my-4">
            ...
            <br />
            2. Ist der Käufer Vollkaufmann, so wird für Streitigkeiten aus sämtlichen gegenwärtigen und zukünftigen Ansprüchen aus der Geschäftsverbindung, einschließlich Wechsel- und Scheckforderungen, als Gerichtsstand der Sitz des
          ...
          <p className="my-4">
            Während der Garantiezeit (=<span className="font-bold">Vollgarantie!)</span> ersetzt die Firma jederzeit jedes schadhafte Teil, das von ihr als schadhaft angesehen wurde. Ein solches Ersatzteil wird durch eine Werksvertretung
            geliefert. Diese Garantie bezieht sich weder auf Schäden, die durch Unfall, Missbrauch, Fahrlässigkeit und unsachgemäße Handhabung entstanden sind, noch auf Verschleißteile (wie z.B.{' '}
            <span className="font-bold">Kollektorkohlen, Flachriemen, Papierfiltertüten, Bürstenwalze, Micro- und Allergiefilter, etc.</span>), oder auf <span className="font-bold">VORTECH FORCE - Erzeugnisse</span> die so repariert wurden,
            dass sie nach Meinung der Firma in ihrer Haltbarkeit oder Zuverlässigkeit beeinträchtigt wurden, oder in denen Teile verwenden worden sind, die nicht von der Firma genehmigt waren. (Reparaturen nur durch autorisierte{' '}
            <span className="font-bold">VORTECH FORCE - Service- und Garantiebeauftragte</span> genehmigt!)
          </p>
          <p className="my-4">
            Die obigen Bestimmungen enthalten die ausschließliche Wiedergutmachung sämtlicher Garantieansprüche oder anderer Ansprüche, die sich auf das beschriebene <span className="font-bold">VORTECH FORCE - Erzeugnis</span> beziehen.
            Eine andere Garantie besteht nicht. Eingeschlossene Garantien, einschließlich solcher mit Marktgängigkeit und Eignung für einen bestimmten Zweck, sind auf (2) Jahre ab Kauf durch den Erstkäufer beschränkt, wenn es sich dabei um{' '}
            <span className="font-bold">VORTECH FORCE - Erzeugnisse</span> handelt, die für Verbraucherzwecke benutzt wurden, auf (2) Jahre ab Kauf durch den Erstkäufer, wenn es sich dabei um{' '}
            <span className="font-bold">VORTECH FORCE - Erzeugnisse</span> handelt, die für kommerzielle Zwecke benutzt wurden. Diese Garantie stellt die ausschließliche Wiedergutmachung dar und jede Haftung für indirekte oder Folgeschäden
            oder für Nebenkosten ist ausgeschlossen.
          </p>
          <p className="my-4">Die Firma übernimmt keine weitere Haftung im Zusammenhang mit dem Verkauf ihrer Erzeugnisse und gestattet auch keinem anderen, eine solche Haftung zu überehmnen.</p>
          <p>
            Die Garantie ist null und nichtig, wenn
            <br />
            1. der <span className="font-bold">VORTECH FORCE</span> nicht von einem unabhängigen <span className="font-bold">VORTECH FORCE - Vertragshändler, - Gebietshändler oder - Vertreter</span> verkauft wurde, der die Garantiekarte
            unterzeichnet hat, oder wenn
            <br />
