    ...
    <Layout title={pageTitle + ' - ' + siteTitle} activeMenu="thermostar">
      ...
      <PageSection headline="THERMOSTAR" id="thermostar">
        ...
        <div className="grid grid-cols-1 gap-6 my-6 sm:my-8 sm:grid-cols-2 lg:grid-cols-4 auto-rows-fr">
          <HeadlineTextElement headline="Trocken-Dampfreinigung" imgSrc="/assets/images/thermostar-logo.jpg">
          ...
          <HeadlineTextElement headline="Kein Leistungsabfall" imgSrc="/assets/images/thermostar-geraet.jpg">
          ...
          <HeadlineTextElement headline="Selbstentkalkend" imgSrc="/assets/images/thermostar-logo.jpg">
          ...
          <HeadlineTextElement headline="Für ein ganzes Leben" imgSrc="/assets/images/thermostar-geraet-schlauch.jpg">
