  ...
  return (
    <PageSection headline="Allgemeine Geschäftsbedingungen für den Kauf und die Lieferung neuwertiger Waren durch die Verkäuferfirma" id="agb">
      <article className="page-section pb-8">
        ...
        <p className="my-4">
          Die obigen Bestimmungen enthalten die ausschließliche Wiedergutmachung sämtlicher Garantieansprüche oder anderer Ansprüche, die sich auf das beschriebene <span className="font-bold">VORTECH FORCE - Erzeugnis</span> beziehen. Eine
          andere Garantie besteht nicht. Eingeschlossene Garantien, einschließlich solcher mit Marktgängigkeit und Eignung für einen bestimmten Zweck, sind auf (2) Jahre ab Kauf durch den Erstkäufer beschränkt, wenn es sich dabei um{' '}
