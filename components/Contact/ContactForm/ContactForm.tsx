    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={styles.checkboxfield}>
        <label className="flex justify-start items-start">
          ...
          <div className={['block tracking-wide text-xs mb-2 select-none', errors.name ? 'text-red-700 dark:text-red-500' : 'dark:text-gray-500'].join(' ')}>
            Ich habe die <Link href="/datenschutz/" className="duration-150 ease-in-out no-underline text-link transition-all hover:underline hover:decoration-dotted dark:text-link-dark hover:dark:text-link-dark-hover">Datenschutzerklärung</Link> gelesen und bin mit der Speicherung/Verarbeitung meiner Kontaktdaten zum Zweck der Kontaktaufnahme einverstanden.
          </div>
        </label>
      </div>
