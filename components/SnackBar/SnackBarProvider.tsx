...
function createCtx<ContextType>(): readonly [() => ContextType, React.Provider<ContextType | undefined>] {
...
function SnackBarProvider(props: Readonly<SnackBarProviderProps>): JSX.Element {
